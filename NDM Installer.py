...
class DesktopMateInstallerApp(ctk.CTk):
    ...
    def handle_install_nagatoro_models(self):
        try:
            ...
            if self.language == "ru":
                self.update_info("Скачиваем модели из репозитория GitHub...")
            else:
                self.update_info("Downloading models from the GitHub repository...")
            ...
            if self.language == "ru":
                self.update_info("Распаковываем модели...")
            else:
            ...
            if self.language == "ru":
                ...
                self.update_info("Customizing icons for model files...")
    ...
    def add_to_autorun(self):
        try:
            ...
            shortcut.IconLocation = desktop_mate_path
            shortcut.Save()
...
if __name__ == "__main__":
    app = DesktopMateInstallerApp()
    app.mainloop()
>>>>>>> 32f2fd03856eb875b4878fadf1b44d2b4dd66dec
